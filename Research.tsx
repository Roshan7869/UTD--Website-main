...
import './Research.css'; // Assuming CSS is in a separate file
    ...
    return (
        <div>
            ...
            <main>
                <section>
                    <h2>Research</h2>
                    <p>Details about research activities and projects can be listed here.</p>
                    <table>
                        <thead>
                            <tr>
                                <th>Image</th>
                        ...
                        <tbody>
                            <tr>
                                <td><img src="vision1.jpg" alt="Vision Image 1" width="100" /></td>
                            ...
                            <tr>
                                <td><img src="vision2.jpg" alt="Vision Image 2" width="100" /></td>
